...
**CellMinerCDB AI** is an open-source bioinformatics and scientific software project for exploring large-scale cancer pharmacogenomic data across genes, drugs, cancer cell lines, tissues and molecular measurements. It combines **CellMinerCDB, Python, R, PostgreSQL, biological knowledge graphs, NetworkX, GraphRAG, PandasAI, Azure OpenAI and Streamlit** in a reproducible research architecture.
...
- **Research software engineering:** includes containerised deployment, environment-based configuration, tests, modular graph components and technical documentation.
...
**Engineering:** Docker, Docker Compose, pytest-compatible tests, environment-based configuration
